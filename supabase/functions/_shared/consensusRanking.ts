/**
 * Shared consensus ranking algorithm — single source of truth (Edge runtime).
 * Mirrors EXACTLY src/lib/consensusRanking.ts so the Agente Rix and the
 * dashboard produce bit-identical orderings.
 *
 * Rules:
...
const LEVEL_ORDER: Record<ConsensusLevel, number> = {
  alto: 0,
  medio: 1,
  bajo: 2,
};
