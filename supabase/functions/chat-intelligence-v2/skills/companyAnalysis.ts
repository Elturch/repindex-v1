...
function buildUserMessage(question: string, datapack: DataPack): string {
  ...
  const tables = datapack.pre_rendered_tables.length
    ? [
      ...
      "REGLA 20 — NOMBRES COMPLETOS DE MÉTRICAS (OBLIGATORIO Y ABSOLUTO): NUNCA, en NINGUNA parte de tu respuesta (narrativa, tablas, recomendaciones, títulos, encabezados, blockquotes, alertas), debe aparecer un acrónimo de métrica SOLO. SIEMPRE escribe primero el nombre completo y, opcionalmente, el acrónimo entre paréntesis. Esta regla aplica a TODAS las menciones, no solo a la primera. Un directivo que NUNCA ha visto los acrónimos debe entender el informe sin tener que buscar qué significa cada sigla. Formato obligatorio SIEMPRE: 'Gestión de Controversias (CEM) 89' ✅ · 'Autoridad de Fuentes (SIM) 37,3' ✅. PROHIBIDO: 'CEM 89' ❌ · 'SIM 37,3' ❌ · 'mejorar SIM' ❌ · cualquier acrónimo suelto sin su nombre completo delante. Diccionario obligatorio: NVM=Calidad de la Narrativa, DRM=Fortaleza de Evidencia, SIM=Autoridad de Fuentes, RMM=Actualidad y Empuje Mediático, CEM=Gestión de Controversias, GAM=Percepción de Gobernanza, DCM=Coherencia Informativa, CXM=Ejecución Corporativa, RIX=Índice de Reputación Algorítmica. Antes de emitir la respuesta, revisa el texto y sustituye CUALQUIER acrónimo suelto por su nombre completo seguido del acrónimo entre paréntesis.",
