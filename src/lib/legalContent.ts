    ...
    sections: [
      {
        ...
        content: [
          "Os presentes Termos e Condições definem e esclarecem a regulamentação legal aplicável ao acesso e utilização do website https://repindex.ai/ (doravante o \"Site\"), da responsabilidade da Reputation Index, Lda., titular do NIF 519 229 185 (doravante \"REPINDEX\"). Quaisquer questões legais referentes ao Site e aos serviços prestados (doravante os \"Serviços\") poderão ser consultadas nas secções Política de Privacidade e Política de Cookies, as quais constituem parte integrante dos presentes Termos e Condições.",
    ...
    sections: [
      {
        ...
        content: [
          "Los presentes Términos y Condiciones definen y aclaran la regulación legal aplicable al acceso y utilización del sitio web https://repindex.ai/ (en adelante el \"Sitio\"), bajo la responsabilidad de Reputation Index, Lda., titular del NIF 519 229 185 (en adelante \"REPINDEX\"). Cualquier cuestión legal referente al Sitio y a los servicios prestados (en adelante los \"Servicios\") podrá consultarse en las secciones Política de Privacidad y Política de Cookies, las cuales forman parte integrante de los presentes Términos y Condiciones.",
