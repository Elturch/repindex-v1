...
/**
 * Signed consensus — distinguishes polarity to avoid the
 * "consensus = everything is fine" misreading. When the 6 AIs agree
 * (range ≤ 10) the average score decides whether they agree on
 * health (positivo), neutrality (neutro) or crisis (crisis).
 * When the range is wider, polarity is irrelevant: medio / disenso.
 */
